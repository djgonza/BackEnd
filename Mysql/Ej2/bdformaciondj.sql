...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2016 a las 09:18:24
...
--
-- Volcado de datos para la tabla `profesoresdj`
--
...
--
-- Filtros para la tabla `cursillosdj`
--
ALTER TABLE `cursillosdj`
  ADD CONSTRAINT `cursillosdj_ibfk_1` FOREIGN KEY (`CODP`) REFERENCES `profesoresdj` (`CODP`) ON DELETE CASCADE ON UPDATE CASCADE;
